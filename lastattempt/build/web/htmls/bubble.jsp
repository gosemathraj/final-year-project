        ...
        <div id="left_inner_section_one">
            <div id="inner_left_inner_section_one">
                ...
                <ul>
                    ...
                    <li>Tree Traversal
                        <ul style="list-style-type:circle; margin-left: 30px;">
                            <li><input type="button" id="button" onclick="app();" value="Inorder"></li>
                            <li>Preorder</li>
                            <li>Postorder</li>
                        </ul>
                    </li>
...
<div id="applet_open" style="display: none;">
    <button onclick="closebp();">close it</button>
    <applet code="BTree.class" height="250" width="500"></applet>
</div>
<script>
            function closebp() {
                
            $('#applet_open').bPopup().close(); 
        };
</script>
</body>
</html>
