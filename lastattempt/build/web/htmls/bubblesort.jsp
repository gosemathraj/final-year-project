...
console.log(numbers1);
 ...
 for(var i=0;i<10;i++){
  ...
  for ( var i=1; i<=10; i++ ) {
    $('<div>' + + '</div>').data( 'number', numbers1[i-1] ).appendTo( '#cardSlots' ).droppable( {
      accept: '#cardPile div',
      hoverClass: 'hovered',
      drop: handleCardDrop
    } );
...
function redirect(){
    window.location="../htmls/bubblesort.jsp";
}


function redirect1(){
    window.location="../htmls/index.jsp";
}

function redirect2(){
    window.location="../htmls/bubblesort1.jsp";
}
    ...
    <div id='pop_score' style="display:none;">
        <div id="popup_container">
            ...
            <div id="popup_nextlevel">
                <button id="popup_button" onclick="redirect2();">next level</button>
            </div>
        </div>
    </div>
    ...
    <div id="time_out" style="display: none">
        <div id="timeout_container">
            <div id="timeout_header">
                <p>timeout lol try again</p>
            </div>
            
            <div id="timeout_nextlevel">
                <button id="popup_button" onclick="redirect();">Retry</button>
            </div>
            
            <div id="timeout_nextlevel">
                <button id="popup_button1" onclick="redirect1();">Quit</button>
            </div>
        </div>
    </div>
